...
public class BankContactAdapter extends RecyclerView.Adapter<BankContactAdapter.ContactViewHolder> {
    ...
    public void onBindViewHolder(@NonNull ContactViewHolder holder, int position) {
        ...
        holder.tvName.setText(c.bankName);
        holder.tvPhone.setText(c.bankNumber);
        holder.imageView.setImageResource(c.imageName);

        holder.itemView.setOnClickListener(v -> {
            AccountInfo.getInstance().setUserAccount(c.bankName);
            AccountInfo.getInstance().setUserNumber(c.bankNumber);
